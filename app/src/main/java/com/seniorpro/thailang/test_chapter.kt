...
class test_chapter : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_test_chapter)

        val Testword = findViewById<Button>(R.id.testword1)
        Testword.setOnClickListener{
