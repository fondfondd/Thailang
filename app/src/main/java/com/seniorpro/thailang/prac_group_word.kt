...
/*        buttonPlayLastRecordAudio_1.setOnClickListener {
    ...
    inner class AsyncTaskExample: AsyncTask<String, String, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            if (result == "") {
                ...
                percen.text = result
                webView_1.loadUrl("http://ec2-35-163-238-165.us-west-2.compute.amazonaws.com/simple.html?w="+words)
            }
        }
    }
    ...
    private fun doFileUpload() : String {
        ...
        val existingFileName = AudioSavePathInDevice
        val lineEnd = "\r\n"
        val twoHyphens = "--"
        val boundary = "*****"
        var bytesRead: Int
    ...
    private fun praat() : String{
        ...
        val API_URL = "http://ec2-35-163-238-165.us-west-2.compute.amazonaws.com/normalize.php?w="+words
        var Result = ""
        try {
